// Minimalist chess pieces designed for dark theme
// These are simplified SVG pieces that work well with the dark green theme

export const chessPieces = {
  // White King
  wK: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45">
    <g fill="#f0f0f0" stroke="#333" stroke-width="1.5" stroke-linejoin="round">
  ...
  wN: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45">
    <g fill="#f0f0f0" stroke="#333" stroke-width="1.5" stroke-linejoin="round">
      ...
      <path d="M9 36c8.51-1.5 19.51-1.5 28 0" stroke-linecap="round"/>
    </g>
  </svg>`,
  
  // White Pawn
  wP: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45">
    <g fill="#f0f0f0" stroke="#333" stroke-width="1.5">
  ...
  bK: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45">
    <g fill="#333" stroke="#f0f0f0" stroke-width="1.5" stroke-linejoin="round">
      <path d="M22.5 11.63V6M20 8h5"/>
      <path d="M22.5 25s4.5-7.5 3-10.5c0 0-1-2.5-3-2.5s-3 2.5-3 2.5c-1.5 3 3 10.5 3 10.5"/>
      <path d="M11.5 37c5.5 3.5 15.5 3.5 21 0v-7s9-4.5 6-10.5c-4-6.5-13.5-3.5-16 4V27v-3.5c-3.5-7.5-13-10.5-16-4-3 6 5 10 5 10V37z"/>
      <path d="M11.5 30c5.5-3 15.5-3 21 0m-21 3.5c5.5-3 15.5-3 21 0m-21 3.5c5.5-3 15.5-3 21 0" stroke="#f0f0f0"/>
    </g>
  </svg>`,
  ...
  bQ: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45">
    <g fill="#333" stroke="#f0f0f0" stroke-width="1.5" stroke-linejoin="round">
      ...
      <path d="M9 26c8.5-1.5 21-1.5 27 0l2.5-12.5L31 25l-.3-14.1-5.2 13.6-3-14.5-3 14.5-5.2-13.6L14 25 6.5 13.5 9 26z"/>
      <path d="M9 26c0 2 1.5 2 2.5 4 1 1.5 1 1 .5 3.5-1.5 1-1.5 2.5-1.5 2.5-1.5 1.5.5 2.5.5 2.5 6.5 1 16.5 1 23 0 0 0 1.5-1 0-2.5 0 0 .5-1.5-1-2.5-.5-2.5-.5-2 .5-3.5 1-2 2.5-2 2.5-4-8.5-1.5-18.5-1.5-27 0z"/>
      <path d="M11 38.5a35 35 1 0 0 23 0" fill="none" stroke="#f0f0f0"/>
    </g>
  </svg>`,
  ...
  bR: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45">
    <g fill="#333" stroke="#f0f0f0" stroke-width="1.5" stroke-linejoin="round">
      ...
      <path d="M31 17v12.5H14V17"/>
      <path d="M31 29.5l1.5 2.5h-20l1.5-2.5"/>
      <path d="M11 14h23" fill="none" stroke="#f0f0f0"/>
    </g>
  </svg>`,
  ...
  bB: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45">
    <g fill="#333" stroke="#f0f0f0" stroke-width="1.5" stroke-linejoin="round">
      ...
      <path d="M17.5 26h10M15 30h15m-7.5-14.5v5M20 18h5" stroke-linejoin="miter" stroke="#f0f0f0"/>
    </g>
  </svg>`,
  ...
  bN: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45">
    <g fill="#333" stroke="#f0f0f0" stroke-width="1.5" stroke-linejoin="round">
      ...
      <path d="M9 36c8.51-1.5 19.51-1.5 28 0" stroke-linecap="round" stroke="#f0f0f0"/>
    </g>
  </svg>`,
  
  // Black Pawn
  bP: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45">
    <g fill="#333" stroke="#f0f0f0" stroke-width="1.5">
      <path d="M22.5 9c-2.21 0-4 1.79-4 4 0 .89.29 1.71.78 2.38C17.33 16.5 16 18.59 16 21c0 2.03.94 3.84 2.41 5.03-3 1.06-7.41 5.55-7.41 13.47h23c0-7.92-4.41-12.41-7.41-13.47 1.47-1.19 2.41-3 2.41-5.03 0-2.41-1.33-4.5-3.28-5.62.49-.67.78-1.49.78-2.38 0-2.21-1.79-4-4-4z"/>
    </g>
  </svg>`
};
...
export function getPieceDataUrl(piece) {
  const svg = chessPieces[piece];
  if (!svg) return null;
  const encoded = encodeURIComponent(svg);
  return `data:image/svg+xml,${encoded}`;
}

// Function to save pieces as files (optional)
export async function savePiecesAsFiles() {
  for (const [piece, svg] of Object.entries(chessPieces)) {
